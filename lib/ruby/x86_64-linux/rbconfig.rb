...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/pancakes/.conan/data/ruby/3.1.0/astrabit/testing/package/fcff4d2998c972787263c14866fbc11a59fe4cb3")
  ...
  CONFIG["configure_args"] = " '--without-ext=dbm,gdbm,pty,readline,syslog' '--disable-install-doc' '--without-gmp' '--enable-shared' '--prefix=/home/pancakes/.conan/data/ruby/3.1.0/astrabit/testing/package/fcff4d2998c972787263c14866fbc11a59fe4cb3' '--bindir=$${prefix}/bin' '--sbindir=$${prefix}/bin' '--libexecdir=$${prefix}/bin' '--libdir=$${prefix}/lib' '--includedir=$${prefix}/include' '--oldincludedir=$${prefix}/include' '--datarootdir=$${prefix}/share' 'CFLAGS=-m64 -O3 -s' 'LDFLAGS=-m64 -L/home/pancakes/.conan/data/openssl/1.1.1l/_/_/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/lib' 'LIBS=' 'CPPFLAGS=-I/home/pancakes/.conan/data/openssl/1.1.1l/_/_/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/include -DNDEBUG' 'CXXFLAGS=-m64 -O3 -s'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/pancakes/.conan/data/ruby/3.1.0/astrabit/testing/package/fcff4d2998c972787263c14866fbc11a59fe4cb3"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lz -lpthread -lrt -lrt -lcapstone -ldl -lcrypt -lm "
  ...
  CONFIG["DLDFLAGS"] = "-m64 -L/home/pancakes/.conan/data/openssl/1.1.1l/_/_/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/lib -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = " -O3 -s"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/home/pancakes/.conan/data/openssl/1.1.1l/_/_/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/include -DNDEBUG $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L.  -L/home/pancakes/.conan/data/openssl/1.1.1l/_/_/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/lib -fstack-protector-strong  -rdynamic -Wl,-export-dynamic -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = " -O3 -s -I/usr/include/capstone -fPIC"
